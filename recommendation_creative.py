...
async def recommendation_creative(update: Update, context) -> None:
    ...
    if mode == 'recommendation-creative-one':
        ...
        keyboard = [[InlineKeyboardButton("Добавить", callback_data='recommendation-creative-two'),
                     InlineKeyboardButton("Потдвердить", callback_data='recommendation-creative-accept')]]
        ...
        creatives = opt_old['creatives'] + '///' + post
        set_opt_recommendation_into(user_id, profile['rec_into_temp'], {'creatives': creatives}, 'none')
        keyboard = [[InlineKeyboardButton("Добавить", callback_data='recommendation-creative-three'),
                     InlineKeyboardButton("Потдвердить", callback_data='recommendation-creative-accept')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        await update.message.reply_text("Хотите отправить креатив?:", reply_markup=reply_markup)
        return
        ...
        creatives = opt_old['creatives'] + '///' + post
        set_opt_recommendation_into(user_id, profile['rec_into_temp'], {'creatives': creatives}, 'none')
        keyboard = [[InlineKeyboardButton("Добавить", callback_data='recommendation-creative-four'),
                     InlineKeyboardButton("Потдвердить", callback_data='recommendation-creative-accept')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        await update.message.reply_text("Хотите отправить креатив?:", reply_markup=reply_markup)
        return
        ...
        creatives = opt_old['creatives'] + '///' + post
        set_opt_recommendation_into(user_id, profile['rec_into_temp'], {'creatives': creatives}, 'none')
        keyboard = [[InlineKeyboardButton("Добавить", callback_data='recommendation-creative-five'),
                     InlineKeyboardButton("Потдвердить", callback_data='recommendation-creative-accept')]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        await update.message.reply_text("Хотите отправить креатив?:", reply_markup=reply_markup)
        return
