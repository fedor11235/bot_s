    ...
    *Владелец:* @''' + str(profile['username']) + '''\n
    ''', reply_markup=reply_markup, parse_mode="Markdown")
                ...
                if query_array[1] == 'opt-into':
                    ...
                    #     print('Processing confirm')
                    #     # TODO: show table with time slots
                    #     recommendation_id = 27
                    #     available_values = await get_available_time_slots(recommendation_id)
                    ...
                    #
                    #     await query.edit_message_text(
                    #         f'Выберите допустимое время размещений:',
                    #         reply_markup=reply_markup)
