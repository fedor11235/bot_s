...
class SlonBot():
  ...
  async def handler_partners(self, update: Update, _) -> None:
    ...
    if user_stat == 'empty':
      ...
      req = requests.get('http://localhost:3002/test/user/promocode' + '?idUser=' + str(update.message.chat.id))
      res = req.json()
      # if res == 'no':
  ...
  async def handler_newopt(self, update: Update, _) -> None:
    ...
    if user_stat == 'empty':
      ...
      if tariff_plan == 'base':
        ...
        req = requests.get(
          'http://localhost:3002/test/chanel/user' +
  ...
  async def response_from__message(self, update: Update, context) -> None:
    ...
    elif mode == 'recommendation-creative-one':
  ...
  async def handler_callback(self, update: Update, context):
    ...
    #!Каналы
      ...
      try:
        ...
        req = requests.get(
          'http://localhost:3002/test/chanel/get' +
